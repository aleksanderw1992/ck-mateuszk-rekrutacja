...
class WikiReaderImplJsonTest {

  private final WikiReaderImplJson reader = new WikiReaderImplJson();

  @Test
  void testValidRead() {
    WikiPage page = reader.read("./src/main/resources/wikiscrapper/site2.json");
